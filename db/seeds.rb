...
scythe = Game.new( name: "Scythe", description: "Scythe gives players almost complete control over their fate. ", price: "4€", min_player:"1", max_player: "5", playtime: "90min", address:"Rue De Wattiessart, Seclin", user: alexis)
...
terraforming_mars = Game.new( name: "Terraforming Mars", description: "In the 2400s, mankind begins to terraform the planet Mars.", price: "6€", min_player:"2", max_player: "5", playtime: "90min", address: "Avenue De La République, Marcq-en-Barœul" , user: alexis)
...
pandemic = Game.new( name: "Pandemic", description: "After five years of Pandemic, hundreds of thousands of players have contracted the virus!", price: "3€", min_player:"2", max_player: "4", playtime: "45min", address: "Rue Faidherbe, Wattignies" , user: camille)
...
wingspan = Game.new( name: "Wingspan", description: "Wingspan is a competitive, medium-weight, card-driven, engine-building board game from Stonemaier Games.", price: "5€", min_player:"2", max_player:"4" , playtime:"40min" , address: "Rue Léon Gambetta, Lille" , user: camille )
...
viticulture = Game.new( name: "Viticulture", description: "Viticulture is a worker-placement game set in the foothills of Tuscany. ", price: "7€", min_player:"1", max_player:"6" , playtime:"120min" , address: "Rue Royale, Lille" , user: camille )
